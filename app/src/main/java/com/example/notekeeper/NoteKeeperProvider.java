...
import static com.example.notekeeper.NoteKeeperProviderContract.CoursesIdColums;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(NoteKeeperProviderContract.AUTHORITY
                , Courses.PATH + "/#", COURSES_ROW);
        sUriMatcher.addURI(NoteKeeperProviderContract.AUTHORITY
                , Notes.PATH_EXPANDED + "/#", NOTES_EXPANDED_ROW);
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch) {
            ...
            case NOTES_EXPANDED:
                //throws exception saying this is a read only table
                break;
