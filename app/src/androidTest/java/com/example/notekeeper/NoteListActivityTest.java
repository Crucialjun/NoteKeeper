        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.text_note_title),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("my note tittle"), closeSoftKeyboard());

        ViewInteraction editText = onView(
                allOf(withId(R.id.text_note_title), withText("my note tittle"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        editText.check(matches(withText("my note tittle")));
